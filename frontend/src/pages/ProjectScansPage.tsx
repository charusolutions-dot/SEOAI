...
export const ProjectScansPage = () => {
  ...
  const { scans, isLoading, error, limitMessage, runScan, isRunningScan } = useProjectScans(id);
  ...
  return (
    <section>
      <h1>Project Scans</h1>
      <button type="button" onClick={() => runScan()} disabled={limitReached || isRunningScan}>
        Run Scan
      </button>
